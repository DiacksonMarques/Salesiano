               ...
               <div class="post-body">
                  <div class="entry-header">
                     <div class="post-meta">
                        ...
                        <span class="post-meta-date"><i class="fa fa-calendar"></i> 03/Março/2020 </span>
                        <span class="post-comment"><i class="fa fa-comment-o"></i> 00<a href="#" class="comments-link">Comentários</a></span>
                     </div>
                     <h2 class="entry-title">
                        <a href="news-single3">Salé Folia 2020 <br> Carnaval com muita alegria e frevo no pé</a>
                     </h2>
                  </div><!-- header end -->

                  <div class="entry-content">
                     <p>O Salé Folia 2020 foi um dia de muita alegria e festa aqui no
                        Colégio Salesiano de Juazeiro do Norte. Foi divertido, cultural e
                        cheio de encantos e cores. O balanço do frevo envolveu a todos e
                        ninguém ficou parado.</p>

                     <p>O evento começou com os pequenos da educação infantil que
                        se dirigiram até o “corredor do frevo” onde todo o colégio desfilou
                        em forma de bloco de carnaval de rua, ao som da banda de frevo
                        Frevioca dos Batutas do Rosário, que animou todo Salé Folia 2020.</p>

                     <p>Os educandos do Fundamental I e II fizeram estandartes
                        temáticos referentes aos carnavais mais tradicionais do Brasil e a
                        galera do Ensino Médio apresentou murais culturais sobre sambas
                        enredo da Escola de Samba Mangueira.</p>

                     <p>Ao final das apresentações a folia foi liberada para todos, os
                        alunos se divertirem no tradicional “mela-mela” de confetes e
                        espumas, próprias para essa finalidade. A garotada se divertiu,
                        brincou, cantou e festejou no carnaval do Salesiano.</p>
                  </div>
