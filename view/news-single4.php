         ...
         <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            ...
            <div class="post-content post-single">
               <div class="post-media post-image image-angle">
                  <img src="../images/news/news4.jpg" class="img-responsive" alt="">
               ...
               <div class="post-body">
                  <div class="entry-header">
                     <div class="post-meta">
                        ...
                        <span class="post-meta-date"><i class="fa fa-calendar"></i> 12/Novembro/2019 </span>
                        <span class="post-comment"><i class="fa fa-comment-o"></i> 00<a href="#" class="comments-link">Comentários</a></span>
                     </div>
                     <h2 class="entry-title">
                        <a href="news-single4">Assembleia Legislativa do Estado do Ceará homenageia Colégio Salesiano de Juazeiro do Norte</a>
                     </h2>
                  </div><!-- header end -->

                  <div class="entry-content">
                     <p>Na última sexta, 08, o Colégio Salesiano São João Bosco e Paróquia do
                        Sagrado Coração de Jesus receberam homenagem da Assembleia Legislativa
                        do Estado do Ceará em comemoração dos 50 anos de inauguração da estátua
                        do Pe. Cícero. Em sessão itinerante os deputados do Ceará se reuniram no
                        memorial Padre Cícero para assinar ordem de serviço para instalação do
                        teleférico que ligará a estação romeiros à estátua do Pe. Cícero, no horto. Após
                        a sessão, os deputados participaram de solenidade que homenageou
                        importantes personalidades e instituições do Cariri.</p>

                     <p>Uma das instituições homenageadas pelos representantes do legislativo
                        estadual foi o Colégio Salesiano São João Bosco, que é peça importante para
                        a educação da região do Cariri. São mais de 50 anos de compromisso e
                        trabalho na área da educação na cidade de Juazeiro do Norte.</p>

                     <p>Com auditório cheio o jornalista Mateus Melo, que representou o diretor
                        do Colégio, Padre Nonato Feitosa, recebeu das mãos do Deputado Federal,
                        Pedro Bezerra e Deputado Estadual, Fernando Santana a singela homenagem
                        de comemoração dos 50 anos desse monumento tão importante para a história
                        que é a estátua do Padre Cícero. Foi uma enorme satisfação representar essa
                        instituição que muito contribuiu e contribui para a região do Cariri seja na área
                        da educação ou no campo da fé e religiosidade, já que o Padre Cícero confiou
                        aos Salesianos a sua missão de evangelizar e cuidar dos seus romeiros
                        ressalta Mateus Melo.</p>
                  </div>
