            ...
            <div class="post-content post-single">
               <div class="post-media post-image image-angle">
                  <div id="page-slider" class="owl-carousel owl-theme page-slider page-slider-small">
                     ...
                     <div class="item">
                        <img src="../images/news/news6.1.jpg" alt="" />
                     </div>
                     <div class="item">
                        <img src="../images/news/news6.2.jpg" alt="" />
                     </div>
                  </div><!-- Page slider end -->
               </div>
               ...
               <div class="post-body">
                  <div class="entry-header">
                     <div class="post-meta">
                        ...
                        <span class="post-meta-date"><i class="fa fa-calendar"></i> 1/Outrubo/2019 </span>
                        <span class="post-comment"><i class="fa fa-comment-o"></i> 00<a href="#" class="comments-link">Comentários</a></span>
                     </div>
                     <h2 class="entry-title">
                        <a href="news-single6">Você não está só, viver é bem melhor!<br>O mês de setembro foi encerrado com ação do setembro amarelo no Colégio Salesiano de Juazeiro do Norte</a>
                     </h2>
                  </div><!-- header end -->

                  <div class="entry-content">
                     <p>Na última quarta, 25, o nosso dia começou bem amarelo. Com laços
                        distribuídos aos educandos e colaboradores, a ação do setembro amarelo
                        motivou toda comunidade educativa e deu início a toda programação da
                        manhã. Educandos do Fundamental II e Médio se dividiram por toda escola em
                        círculos juntamente com seus professores e colaboradores, em cada círculo
                        houve uma reflexão sobre o tema: “Escolhe, pois, a vida” (Dt 30,15).</p>

                     <p>Logo depois, balões amarelos foram cheios representando cada
                        estudante salesiano, e o sopro caracterizando a vida, o sopro de Deus. Todos
                        os alunos se dirigiram ao Santuário do Sagrado Coração de Jesus e de mãos
                        dadas fizeram uma oração e abraçaram a Igreja, gesto simbólico de abraçar a
                        vida, os irmãos e todos que precisam de um olhar e um abraço na certeza de
                        que viver é bem melhor!</p>

                     <p>A manhã foi finalizada com a presença das psicólogas, Andrya Kelly,
                        Fázia Torres, Sandra Soraia e da enfermeira Soraya Lopes, que realizaram um
                        bate-papo com as turmas sobre a Valorização da Vida, Saúde Mental e Projeto
                        de Vida. Foi uma manhã rica em afeto, reflexão e conhecimento. A ação foi
                        coordenada pelo SOE (Serviço de Orientação Escolar) e pela Pastoral Juvenil
                        Salesiana. Foi um momento importante de valorização da vida e reflexão sobre
                        a temática, ressalta o Ir. Yuri Kiuski, coordenador de pastoral.</p>

                     <p><b>Você não está só, viver é bem melhor!</b></p>
                  </div>

                  <div class="tags-area clearfix">
                     <div class="post-tags pull-left">
                        <a href="#">Cólegio Salesiano</a>
                        <a href="#">Enino fundamental II</a>
                        <a href="#">Enino Médio</a>
                     </div>
