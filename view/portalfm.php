                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Usuário:</label>
                                                        <input name="usuario" class="form-control form-control-name" onkeyup="mascPORTAL(this.value)" id="portal" type="text" required="Digite o login" placeholder="Usuário"  minlength="11" maxlength="14">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
